...
let calculate = () => {
        ...
        //
        PrincAmount.innerHTML = `Principal Amount: <strong> &#8377 ${p.toFixed(2)}</strong>`;
        interestResult.innerHTML = `Total interest: <strong> &#8377 ${simpleInterest.toFixed(2)}</strong>`;
        TtlamountResult.innerHTML = `Total Amount: <strong> &#8377 ${amount.toFixed(2)}</strong>`;
}
